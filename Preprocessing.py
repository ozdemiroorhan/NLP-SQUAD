...
class Preprocessing:
    ...
    def pad_input_lines(self, tokenized_input_lines, max_input_seq_len, tokenizer):
        ...
        padded_input_lines = preprocessing.sequence.pad_sequences(tokenized_input_lines, maxlen=max_input_seq_len,
                                                                  padding='post')
    ...
    def set_target_tokens(self, tokenized_output_lines, max_output_len, num_output_tokens):
        ...
        padded_output_lines = preprocessing.sequence.pad_sequences(decoder_target_data, maxlen=max_output_len,
                                                                   padding='post')
